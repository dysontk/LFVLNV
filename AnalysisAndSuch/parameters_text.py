Parameters_to_write = ['''# This file was automatically created by Param_space_explorer.
...
procText = '''import model O2_flavor
generate p p > j j l- l-
add process p p > j j l+ l+
add process p p > j j j l+ l+ 
add process p p > j j j l- l-
output /work/pi_mjrm_umass_edu/LNV_collider/Generated/Signal/LNVF'''