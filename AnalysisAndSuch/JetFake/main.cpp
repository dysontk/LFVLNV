...
int main(int argc, const char * argv[])
{
    ...
    int MW2j2lHistoParams[3] = {18,0, 1000}; // current bounds are to have the same range and bin sizes as Gang's data
    ...
    int MW2j1l_0HistoParams[3] = {25, 0, 800};
    ...
    int MW2j1l_1HistoParams[3] = {18, 0, 700};
