...
int main(int argc, const char * argv[])
{
    ...
    int MW2j1l_0HistoParams[3] = {20, 0, 600*scaleFactor};
...
// Figure out how to best use this later based on how I do the cuts
    ...
    */
    ...
    else
    {
        ...
        strcat(FullPathM2jW, "/images/Mass_2jW.png");
        // MW2j
        ...
        strcat(FullPathM2jW2l, "/images/Mass_2jW2l.png");
        ...
        strcat(FullPath2jW1l0, "/images/Mass_2jW1l0.png");
        ...
        strcat(FullPathMass_2jW1l1, "/images/Mass_2jW1l1.png");
