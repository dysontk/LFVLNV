...
int main(int argc, const char * argv[]) {
    ...
    char extradir1[50] = "output/";
    char extradir2[50] = "output/";
    char extradir3[50] = "output/";
    ...
    lEgy2 = strcat( extradir1, strcat( strcat(lEgy2Head, label), lFileFormat));
    // extradir[50] = "output/";
    // cout << lEgy2 << endl;
    // cout << extradir << endl;
    lEgy3 = strcat( strcat(lEgy3Head, label), lFileFormat);
    lEgy4 = strcat( strcat(lEgy4Head, label), lFileFormat);
    lEgy5 = strcat( extradir2, strcat( strcat(lEgy5Head, label), lFileFormat));
    // extradir[50] = "output/";
    // cout << lEgy2 << endl;
    // cout << lEgy5 << endl;
    // cout << extradir << endl;
    lEgy6 = strcat( extradir3, strcat( strcat(lEgy6Head, label), lFileFormat));
    // extradir[50] = "output/";
    // cout << lEgy2 << endl;
    // cout << lEgy5 << endl;
    // cout << lEgy6 << endl;
...
// emu
  // if (f_lep[0].pt() < 25 || f_lep[1].pt() < 10) continue;
   ...
   if (rs < r1) {
    ...
    // cout << "pair type: " << 1 << endl;
     if (f_lep[0].pt() < 20 || f_lep[1].pt() < 10) continue;

   }

   else {
    // cout << "pair type: " << 2 << endl;
     if (f_lep[0].pt() < 25 || f_lep[1].pt() < 10) continue;
